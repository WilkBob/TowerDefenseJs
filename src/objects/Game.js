  ...
  draw() {
    ...
    this.objects.spritesheets.forEach((spritesheet) => {
      ...
      if (spritesheet.frame === spritesheet.frames) {
        this.objects.spritesheets.splice(
          this.objects.spritesheets.indexOf(spritesheet),
          1,
        );
      }
    });
